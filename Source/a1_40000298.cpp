...
int compileAndLinkShaders2()
{
    ...
    const char* vertexShaderSource = getVertexShaderSource2();
    ...
    const char* fragmentShaderSource = getFragmentShaderSource2();
...
int a1main()
{
    ...
    int shaderProgram = compileAndLinkShaders2();
    ...
    int vbo = createVertexBufferObject2();
